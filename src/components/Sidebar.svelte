...
<div class="flex flex-col fixed top-0 left-0 z-10 w-screen h-screen py-[24px] ring ring-1 justify-between transform transition duration-200 overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-primary-500 scrollbar-track-rounded-full {show?'translate-x-0':'translate-x-[100%] lg:translate-x-[-100%]'} ring-white ring-opacity-[2%] ring-inset backdrop-filter backdrop-blur-md lg:w-auto">
  ...
  <div class="flex mb-[-8px]">
    <a on:click|preventDefault={signOut} href="/signout" class="hover:text-primary-500 {linkClasses}">Sign Out</a>
  </div>
</div>
<div class="w-full flex justify-end p-[24px] ring ring-1 ring-white ring-opacity-[2%] pointer-events-none lg:w-auto lg:h-auto">
