...
export default {
  ...
  range:
    'appearance-none bg-gray-900/[.1] dark:bg-gray-50/[.05] outline-none h-[.5rem] rounded-full [&::-webkit-slider-thumb]:hover:cursor-pointer [&::-webkit-slider-thumb]:transition [&::-webkit-slider-thumb]:duration-200 [&::-webkit-slider-thumb]:ring [&::-webkit-slider-thumb]:ring-transparent focus:[&::-webkit-slider-thumb]:ring-primary-500/[.3] [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:bg-primary-500 [&::-webkit-slider-thumb]:w-[1.5rem] [&::-webkit-slider-thumb]:h-[1.5rem] [&::-webkit-slider-thumb]:rounded-full',
